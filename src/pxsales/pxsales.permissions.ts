...
export const PXSALES_PERMISSIONS = [
  ...
  { acao: "pxsales.tabelas.create", grupo: "Tabelas comerciais", label: "Criar tabelas e versões" },
  { acao: "pxsales.tabelas.edit", grupo: "Tabelas comerciais", label: "Editar tabelas e componentes" },
  { acao: "pxsales.tabelas.publish", grupo: "Tabelas comerciais", label: "Publicar versões de tabela" },
  { acao: "pxsales.tabelas.manage", grupo: "Tabelas comerciais", label: "Administrar tabelas (arquivar, exceções)" },
