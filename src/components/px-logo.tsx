...
export function PXLogo({
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const letters = gsap.utils.toArray<SVGPathElement>(root.querySelectorAll('[data-logo-part^="letter-"]'));
    const stage = root.querySelector<SVGGElement>('[data-logo-part="stage"]');
    if (!symbol || !p || xParts.length !== 3 || letters.length !== 5 || !stage) return;

    const context = gsap.context(() => {
      gsap.set([symbol, p, ...xParts, ...letters, stage], { transformOrigin: "50% 50%", transformBox: "fill-box" });

      if (reducedMotion) {
        gsap.set([symbol, p, ...xParts, ...letters, stage], { clearProps: "all" });
        return;
      }
    ...
    <span ref={rootRef} className={`px-logo ${className}`} style={style} data-px-logo>
      ...
      >
        <g data-logo-part="stage">
          ...
          <path data-logo-part="letter-r" d="M8705 4003 c-86 -19 -151 -66 -184 -132 -27 -54 -64 -215 -63 -278 1 -69 20 -99 88 -133 44 -22 61 -25 164 -25 68 0 134 6 163 14 62 18 129 78 155 139 31 70 66 254 57 299 -10 54 -59 98 -123 112 -51 11 -216 13 -257 4z m195 -118 c26 -23 26 -65 0 -173 -24 -102 -42 -138 -78 -156 -41 -20 -112 -27 -152 -13 -53 19 -59 48 -32 175 24 117 41 148 93 175 44 24 139 19 169 -8z" />
          <path data-logo-part="letter-u" d="M6730 3998 c0 -3 -29 -127 -65 -277 -36 -150 -65 -275 -65 -277 0 -2 36 -4 79 -4 89 0 81 -8 102 95 15 74 23 85 64 85 29 0 65 -24 65 -44 0 -4 17 -36 37 -71 l37 -65 89 0 89 0 -21 33 c-27 40 -83 148 -79 151 2 1 22 10 45 20 52 23 76 48 102 106 46 105 34 192 -31 227 -28 15 -63 18 -240 21 -115 2 -208 2 -208 0z m309 -109 c28 -10 31 -15 31 -52 0 -90 -51 -127 -177 -127 -50 0 -63 3 -63 15 0 14 25 127 36 163 4 15 128 17 173 1z" />
          <path data-logo-part="letter-p" d="M7300 3828 c-53 -219 -59 -281 -30 -326 11 -18 37 -40 58 -49 56 -24 213 -29 291 -9 129 33 153 70 216 336 25 107 48 201 50 208 3 9 -17 12 -79 12 l-83 0 -32 -147 c-51 -234 -66 -280 -101 -298 -16 -8 -53 -15 -83 -15 -99 0 -105 30 -52 262 20 84 38 163 40 176 5 21 3 22 -74 22 l-79 0 -42 -172z" />
          <path data-logo-part="letter-o" d="M7950 3908 c-12 -51 -37 -158 -56 -238 -19 -80 -38 -164 -41 -187 l-6 -43 76 0 76 0 10 38 c6 20 11 42 11 47 0 6 5 26 10 46 l10 37 123 4 c178 6 228 33 272 152 26 68 25 137 -1 173 -39 52 -62 58 -270 61 l-192 4 -22 -94z m330 -36 c15 -18 16 -29 8 -64 -5 -23 -14 -49 -21 -57 -21 -25 -75 -41 -141 -41 l-64 0 15 58 c8 31 19 74 24 96 l10 38 76 -4 c63 -3 78 -7 93 -26z" />
            </g>
          </g>
        </g>
      </svg>
