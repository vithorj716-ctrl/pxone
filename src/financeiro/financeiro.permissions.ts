...
export const FINANCEIRO_PERMISSIONS = [
  ...
  { acao: "financeiro.recibos.manage", grupo: "Documentos", label: "Gerenciar e reemitir recibos" },
  ...
  { acao: "financeiro.comissoes.manage", grupo: "Comercial", label: "Gerenciar comissões no Financeiro" },
  ...
  { acao: "financeiro.contas.view", grupo: "Configurações", label: "Ver contas financeiras" },
  { acao: "financeiro.contas.manage", grupo: "Configurações", label: "Gerenciar contas financeiras" },
  { acao: "financeiro.categorias.view", grupo: "Configurações", label: "Ver categorias e centros de custo" },
  { acao: "financeiro.categorias.manage", grupo: "Configurações", label: "Gerenciar categorias e centros de custo" },
